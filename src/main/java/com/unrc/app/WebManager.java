...
+"<script src='http://localhost:4567/js/jquery-1.11.3.min.js' type='text/javascript'></script>"
+"<script> $(document).ready(function() { var c ; var x='green' ; var gameOver=false ; var gameReport ; var pageBody = $(document.body); "
+ "pageBody.css('zoom', '150%'); pageBody.css('background-color', '#dfe3ee');  "
     
      +"$('#fstColBut').click(function (){jQuery.ajaxSetup({async:false}); $.get('/play/1', function(data){ if (data.indexOf('winner')>-1){ gameReport= 'http://' + data ; gameOver = true ; $(location).attr('href', 'http://' + data)}  ; if (" + turn + ") {$('#' + data).css('background-color','green')} else {$('#' + data).css('background-color','red')} ; $(':button').attr('disabled','-1') } ).done(function() { setTimeout(alert('esperame'), 1000000000); jQuery.ajaxSetup({async:false}); $.get('/ajaxpausedgamecheck', function(data) { if(data=='yes') { jQuery.ajaxSetup({async:false}) ; $.get('/ajaxturncheck', function(res) { if (res='no') { alert('Tu oponente ha pausado la partida') ; $(location).attr('href', '/'); }                    });                                 } else {                           setTimeout(checkTurn,1000) ;  function checkTurn () { $.get( '/ajaxturncheck', function( data ) { if (data=='yes') { jQuery.ajaxSetup({async:false});  $.get('/ajaxreadchannel', function( arr ) { if (arr.indexOf('l')>-1) { if (" + turn + ")  {$('#' + arr[arr.length - 3] + arr[arr.length - 2]).css('background-color', 'red')} else {$('#' + arr[arr.length - 3] + arr[arr.length - 2]).css('background-color', 'green')};  alert ('Has Perdido la Partida ') ; $(location).attr('href', '/'); } else { if (" + turn + ")  {$('#' + arr[arr.length - 2] + arr[arr.length - 1]).css('background-color', 'red')} else {$('#' + arr[arr.length - 2] + arr[arr.length - 1]).css('background-color', 'green')}; } } ) ; $(':button').removeAttr('disabled'); if (" + turn + ") { $('#saveButton2').attr('disabled','-1')} else { $('#saveButton1').attr('disabled','-1')  } ; x= invertColor(" + color + "); } else { setTimeout(checkTurn, 2000); }})   }  ;                     }                                });                 })  }) ;"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           //else //ajaxpausedgame  //done 
  
                  
    +"$('#sndColBut').click(function (){jQuery.ajaxSetup({async:false}); $.get('/play/2', function(data){ if (data.indexOf('winner')>-1){ gameReport= 'http://' + data ; gameOver = true ; $(location).attr('href', 'http://' + data)}  ; if (" + turn + ") {$('#' + data).css('background-color','green')} else {$('#' + data).css('background-color','red')} ; $(':button').attr('disabled','-1') } ).done( function() { setTimeout(checkTurn,1000) ; function checkTurn () { $.get( '/ajaxturncheck', function( data ) { if (data=='yes') { jQuery.ajaxSetup({async:false}); $.get('/ajaxreadchannel', function( arr ) { if (arr.indexOf('l')>-1) { if (" + turn + ")  {$('#' + arr[arr.length - 3] + arr[arr.length - 2]).css('background-color', 'red')} else {$('#' + arr[arr.length - 3] + arr[arr.length - 2]).css('background-color', 'green')};  alert ('Has Perdido la Partida ') ; $(location).attr('href', '/'); } else { if (" + turn + ")  {$('#' + arr[arr.length - 2] + arr[arr.length - 1]).css('background-color', 'red')} else {$('#' + arr[arr.length - 2] + arr[arr.length - 1]).css('background-color', 'green')}; } } ) ; $(':button').removeAttr('disabled'); if (" + turn + ") { $('#saveButton2').attr('disabled','-1')} else { $('#saveButton1').attr('disabled','-1')  } ; x= invertColor(" + color + "); } else { setTimeout(checkTurn, 2000); }})   }  ; })}) ;"                 
    +"$('#thrColBut').click(function (){jQuery.ajaxSetup({async:false}); $.get('/play/3', function(data){ if (data.indexOf('winner')>-1){ gameReport= 'http://' + data ; gameOver = true ;  $(location).attr('href', 'http://' + data)}  ; if (" + turn + ") {$('#' + data).css('background-color','green')} else {$('#' + data).css('background-color','red')} ; $(':button').attr('disabled','-1') } ).done(function() { setTimeout(checkTurn,1000) ; function checkTurn () { $.get( '/ajaxturncheck', function( data ) { if (data=='yes') { jQuery.ajaxSetup({async:false}); $.get('/ajaxreadchannel', function( arr ) { if (arr.indexOf('l')>-1) { if (" + turn + ")  {$('#' + arr[arr.length - 3] + arr[arr.length - 2]).css('background-color', 'red')} else {$('#' + arr[arr.length - 3] + arr[arr.length - 2]).css('background-color', 'green')};  alert ('Has Perdido la Partida ') ; $(location).attr('href', '/'); } else { if (" + turn + ")  {$('#' + arr[arr.length - 2] + arr[arr.length - 1]).css('background-color', 'red')} else {$('#' + arr[arr.length - 2] + arr[arr.length - 1]).css('background-color', 'green')}; } } ) ; $(':button').removeAttr('disabled'); if (" + turn + ") { $('#saveButton2').attr('disabled','-1')} else { $('#saveButton1').attr('disabled','-1')  } ; x= invertColor(" + color + ");} else { setTimeout(checkTurn, 2000); }})   }  ; })  }) ;"
    +"$('#fourColBut').click(function (){jQuery.ajaxSetup({async:false}); $.get('/play/4', function(data){ if (data.indexOf('winner')>-1){ gameReport= 'http://' + data ; gameOver = true ; $(location).attr('href', 'http://' + data)}  ; if (" + turn + ") {$('#' + data).css('background-color','green')} else {$('#' + data).css('background-color','red')} ; $(':button').attr('disabled','-1') } ).done(function() { setTimeout(checkTurn,1000) ; function checkTurn () { $.get( '/ajaxturncheck', function( data ) { if (data=='yes') { jQuery.ajaxSetup({async:false}); $.get('/ajaxreadchannel', function( arr ) {  if (arr.indexOf('l')>-1) { if (" + turn + ")  {$('#' + arr[arr.length - 3] + arr[arr.length - 2]).css('background-color', 'red')} else {$('#' + arr[arr.length - 3] + arr[arr.length - 2]).css('background-color', 'green')};  alert ('Has Perdido la Partida ') ; $(location).attr('href', '/');  } else {   if (" + turn + ")  {$('#' + arr[arr.length - 2] + arr[arr.length - 1]).css('background-color', 'red')} else {$('#' + arr[arr.length - 2] + arr[arr.length - 1]).css('background-color', 'green')};  }  } ) ; $(':button').removeAttr('disabled'); if (" + turn + ") { $('#saveButton2').attr('disabled','-1')} else { $('#saveButton1').attr('disabled','-1')  } ; x= invertColor(" + color + "); } else { setTimeout(checkTurn, 2000); }})   }  ; })  }) ;"
    +"$('#fiveColBut').click(function (){jQuery.ajaxSetup({async:false}); $.get('/play/5', function(data){ if (data.indexOf('winner')>-1){ gameReport= 'http://' + data ; gameOver = true ; $(location).attr('href', 'http://' + data)}  ; if (" + turn + ") {$('#' + data).css('background-color','green')} else {$('#' + data).css('background-color','red')} ; $(':button').attr('disabled','-1')  }   ).done(function() { setTimeout(checkTurn,1000) ; function checkTurn () { $.get( '/ajaxturncheck', function( data ) { if (data=='yes') { jQuery.ajaxSetup({async:false}); $.get('/ajaxreadchannel', function( arr ) { if (arr.indexOf('l')>-1) { if (" + turn + ")  {$('#' + arr[arr.length - 3] + arr[arr.length - 2]).css('background-color', 'red')} else {$('#' + arr[arr.length - 3] + arr[arr.length - 2]).css('background-color', 'green')};  alert ('Has Perdido la Partida ') ; $(location).attr('href', '/'); } else { if (" + turn + ")  {$('#' + arr[arr.length - 2] + arr[arr.length - 1]).css('background-color', 'red')} else {$('#' + arr[arr.length - 2] + arr[arr.length - 1]).css('background-color', 'green')}; } } ) ; $(':button').removeAttr('disabled'); if (" + turn + ") { $('#saveButton2').attr('disabled','-1')} else { $('#saveButton1').attr('disabled','-1')  } ; ;x= invertColor(" + color + "); } else { setTimeout(checkTurn, 2000); }})   }  ; })  }) ;"
    +"$('#sixColBut').click(function (){jQuery.ajaxSetup({async:false}); $.get('/play/6', function(data){ if (data.indexOf('winner')>-1){ gameReport= 'http://' + data ; gameOver = true ; $(location).attr('href', 'http://' + data)}  ; if (" + turn + ") {$('#' + data).css('background-color','green')} else {$('#' + data).css('background-color','red')} ; $(':button').attr('disabled','-1')  }   ).done(function() { setTimeout(checkTurn,1000) ; function checkTurn () { $.get( '/ajaxturncheck', function( data ) { if (data=='yes') { jQuery.ajaxSetup({async:false}); $.get('/ajaxreadchannel', function( arr ) { if (arr.indexOf('l')>-1) { if (" + turn + ")  {$('#' + arr[arr.length - 3] + arr[arr.length - 2]).css('background-color', 'red')} else {$('#' + arr[arr.length - 3] + arr[arr.length - 2]).css('background-color', 'green')};  alert ('Has Perdido la Partida ') ; $(location).attr('href', '/'); } else { if (" + turn + ")  {$('#' + arr[arr.length - 2] + arr[arr.length - 1]).css('background-color', 'red')} else {$('#' + arr[arr.length - 2] + arr[arr.length - 1]).css('background-color', 'green')}; } } ) ; $(':button').removeAttr('disabled'); if (" + turn + ") { $('#saveButton2').attr('disabled','-1')} else { $('#saveButton1').attr('disabled','-1')  } ; ;x= invertColor(" + color + "); } else { setTimeout(checkTurn, 2000); }})   }  ; })  }) ;"
    +"$('#sthColBut').click(function (){jQuery.ajaxSetup({async:false}); $.get('/play/7', function(data){ if (data.indexOf('winner')>-1){ gameReport= 'http://' + data ; gameOver = true ; $(location).attr('href', 'http://' + data)}  ; if (" + turn + ") {$('#' + data).css('background-color','green')} else {$('#' + data).css('background-color','red')} ; $(':button').attr('disabled','-1')  }   ).done(function() { setTimeout(checkTurn,1000) ; function checkTurn () { $.get( '/ajaxturncheck', function( data ) { if (data=='yes') { jQuery.ajaxSetup({async:false}); $.get('/ajaxreadchannel', function( arr ) { if (arr.indexOf('l')>-1) { if (" + turn + ")  {$('#' + arr[arr.length - 3] + arr[arr.length - 2]).css('background-color', 'red')} else {$('#' + arr[arr.length - 3] + arr[arr.length - 2]).css('background-color', 'green')};  alert ('Has Perdido la Partida ') ; $(location).attr('href', '/'); } else { if (" + turn + ")  {$('#' + arr[arr.length - 2] + arr[arr.length - 1]).css('background-color', 'red')} else {$('#' + arr[arr.length - 2] + arr[arr.length - 1]).css('background-color', 'green')}; } } ) ; $(':button').removeAttr('disabled'); if (" + turn + ") { $('#saveButton2').attr('disabled','-1')} else { $('#saveButton1').attr('disabled','-1')  } ; ; x= invertColor(" + color + ");} else { setTimeout(checkTurn, 2000); }})   }  ; })  }) ;"
...
+ "});" 
+"</script>"
+"<script type='text/javascript' > function invertBool ( b ) { var c = !b ; return c }  </script>" 
